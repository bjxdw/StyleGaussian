...
def training(dataset, opt, pipe, ckpt_path, decoder_path, style_weight, content_preserve):
    ...
    opt.iterations = 200_000 if not decoder_path else 3000
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        with torch.no_grad():
            ...
            if iteration % 10000 == 0 and iteration > 0:
                ...
                torch.save(gaussians.capture(is_style_model=True), args.model_path + "/chkpnt" + f"/gaussians_checkpoint{iteration}.pth")
